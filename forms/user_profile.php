...
<?php include 'header.php';?>    
	 <fieldset class="reg">
			<form name= "regform" onsubmit ="return validateForm();" action = "../control/admin_profile_update.php"  method="POST" >
				...
				<input type="hidden" name="id" id = "id" value="<?php echo $_SESSION['user_id'] ?>"></span>
                

		        <label>Name</label> 
				<input type="text" name="name" id = "name" value="<?php echo $_SESSION['user_name'] ?>"><span style= "color:red" id = "alert"></span>
                 <br><hr>
				 <label>E-mail</label>
				<input type="text" name="email" id = "email" value="<?php echo $_SESSION['user_email'] ?>"><span style= "color:red" id = "alert1"></span>
                <br><br><hr>
				
				<label>Password</label>
				<input type="Password" name="password" id = "password"value="<?php echo $_SESSION['user_pass'] ?>" ><span style= "color:red" id = "alert4"></span>
